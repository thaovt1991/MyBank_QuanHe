...
@Controller
public class TransferOldController {
...
//    @ModelAttribute("customerListRecipient")
//    public Iterable<Customer> provinces(Long id) {
//        return customerService.findAllByIdIsNot(id);
//    }
